			...
			<div class="row mb-2">
				...
				<div class="col-md-2 mb-2">
					...
					<div class="contArchivos">
						<a href="#{{$archivo->id}}"><img class="img-fluid" src="{{ $archivo->ref_foto }}"></a>
						<div class="overlay">
				...
				<div class="remodal" data-remodal-id="{{$archivo->id}}">
					...
					<div class="row text-center">
						...
						@if($archivo->tipo_archivo == 'Foto')
							<div class="contArchivos">
								<a><img class="img-fluid" src="{{ $archivo->ref_foto }}"></a>
								<div class="overlay">
									<a class="image-link icon" href="{{ $archivo->ref_foto }}">
						...
						@elseif($archivo->tipo_archivo == 'Video')
							<div class="contArchivos">
								...
								<div class="overlay">
									<a class="video-link icon" href="{{ $archivo->ref_foto }}">
										<i data-remodal-action="confirm" class="fa fa-expand"></i>
									</a>
								</div>
							</div>
